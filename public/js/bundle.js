...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWxpZXZ6bGF0a28iLCJhIjoiY2tmZm8zYnpyMDY0azJ4czVkZWdjanRtZiJ9.sN-a-p301zCYuaCgs26iKg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("http://127.0.0.1:5000/api/v1/bookings/checkout-session/".concat(tourId));

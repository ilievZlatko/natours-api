...
})(
  {
      ...
      function (require, module, exports) {
        ...
        var displayMap = function displayMap(locations) {
          mapboxgl.accessToken =
            'pk.eyJ1IjoiaWxpZXZ6bGF0a28iLCJhIjoiY2tmZm8zYnpyMDY0azJ4czVkZWdjanRtZiJ9.sN-a-p301zCYuaCgs26iKg';
          var map = new mapboxgl.Map({
            container: 'map',
            style: 'mapbox://styles/ilievzlatko/ckffowbqj1gec19nkzx7r4mtt',
          ...
          locations.forEach(function (loc) {
            ...
            new mapboxgl.Popup({
              ...
              .addTo(map); // Extends map bounds to include current location
                ...
                function _callee$(_context) {
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 4:
                        roughRes = _context.sent;
                        _context.next = 7;
                        return roughRes.json();
    ...
    'stripe.js': [
      function (require, module, exports) {
        ...
        var stripe = Stripe('pk_test_hN3H7PCjTT2Uu5Kg2W0NU1Zm');
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 3;
                        return fetch(
                          'http://127.0.0.1:5000/api/v1/bookings/checkout-session/'.concat(
                            tourId
                          )
                        );
